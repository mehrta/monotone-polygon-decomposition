...
namespace Analyzer
{
    ...
    {
        private struct _ExecutionResult_Greedy
        {
        ...
        public struct ExecutionResult_Greedy
        {
            public int NumMonotoneComponents;
            public int NumMerges;
            public int NumSplits;
        ...
        //
        const string MONOTONE_DLL_PATH = @"E:\Development\My Projects\PolygonDecomposition\Gui\bin\Release\MonotoneDecomposition.dll";
        ...
        /// <returns></returns>
        [DllImport(MONOTONE_DLL_PATH, CallingConvention = CallingConvention.Cdecl)]
        private static extern _ExecutionResult_Greedy Decompose_GreedyOrSeidel(int algorithm, Vertex[] vertices, int numVertices, int maxDepthTraverse);


        //
        // CGAL.dll
        //
        const string CGAL_DLL_PATH = @"E:\Development\My Projects\PolygonDecomposition\Gui\bin\Release\cgal.dll";
        ...
        //
        public static ExecutionResult_Greedy DecomposePolygon_GreedyOrSeidel(int algorithm, Vertex[] vertices, int maxDepthTraverse)
        {
            _ExecutionResult_Greedy tmpEr;
            ExecutionResult_Greedy er = new ExecutionResult_Greedy();
